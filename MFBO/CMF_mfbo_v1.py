...
if __name__ == '__main__':
    ...
    for iter in range(10):
        ...
        Acq_fun = CMF_KG(fidelity_num=len(initial_data), GP_model_list=[model, model_init], cost=Data_cost, data_model=Data_model, data_manager=fidelity_manager,model_name='AR', seed=seed)
