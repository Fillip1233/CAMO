...
def fabolas(exp_config):
    ...
    path_csv = sys.path[-1] + '/ICLR_exp2/CMF/Exp_results/'+exp_config['Exp_marker']+'/' + data_name + '/' + exp_config['cost_type'] + '/'
...
if __name__ == '__main__':
    ...
    # Set up logging
    log_file_path = os.path.join(sys.path[-1], 'ICLR_exp2', 'CMF', 'Exp_results', Exp_marker, data_name, args.cost_type, 'fabolas.log')
