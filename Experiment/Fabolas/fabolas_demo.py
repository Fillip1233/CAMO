...
if __name__ == '__main__':
    ...
    for seed in [0,1,4]:
        exp_configuration = {'seed': seed, 'data_name': data_name, 'data_model': Data_list[data_name], 'initial_num': [10,4], 'cost_type': args.cost_type, 'BO_iterations': 10, 'MF_iterations': 100, 'MF_learning_rate': 0.0001}
