...
Dic = {'AR_UCB': ['#000080', "^", "AR-MF-UCB", "solid"],
       ...
       'ResGP_cfKG': ['#00CCFF', "X", "ResGP-cfKG", "solid"],
        ...
        'fabolas_con':['#808000', "*", "Fabolas", 'solid'],
...
max_dic = {'non_linear_sin':0, 'Forrester': 50, 'Park3': 2.2}
add_dict = {'Forrester': 7 ,'non_linear_sin': 0.15,'Park3':0}
cost_lim_y = {'pow_10': [0, 55], 'linear': [0, 55], 'log': [0, 55]}
cost_lim_x = {'pow_10': [48, 138], 'linear': [30, 128], 'log': [15, 135]}
...
# cost_list = ['linear', 'pow_10']
# cost_label_dic = {'linear': 'Linear', 'pow_10': 'Power 10'}
...
plt.tight_layout()
# plt.savefig(os.path.join(sys.path[-1], 'Experiment', 'DMF', 'paper_yx') + '/' +'CMF_' + data_name + '_cost.pdf', bbox_inches='tight')
