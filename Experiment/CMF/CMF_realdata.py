...
Data_list = {'non_linear_sin': non_linear_sin, 'forrester2': forrester, 'Branin2':Branin,'Park2':Park,"Currin2":Currin,
             'HeatedBlock2':HeatedBlock,'VibratePlate':VibPlate}
...
def MF_BO_discrete(exp_config):
    ...
    x_normer = min_max_normalizer_2(x,columns=[0,1,2],min_value=0,max_value=1)
    y_normer = min_max_normalizer_2(y,columns=[0],min_value=0,max_value=1)
    ...
    while flag:
        ...
        if exp_config["Acq_function"] == "UCB":
            ...
            Acq_function = Acq_list[exp_config["Acq_function"]](
                                                                ...
                                                                posterior_function=GP_model,
                                                                model_objective_new=GP_model_new,
                                                                data_model=data,
                                                                model_cost=model_cost,
                                                                search_range=search_range,
                                                                data_manager=fidelity_manager, 
        ...
        #     if new_x[0][k] > search_range[0][1]:
        #         new_x[0][k] = search_range[0][1]-0.001
        #     elif new_x[0][k] < search_range[0][0]:
        #         new_x[0][k] = search_range[0][0]+0.001
        ...
        new_x = x_normer.normalize(new_x)
        ...
        # if args.data_name in ["Branin2","Park2","Currin2"]:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_name", type=str, default="HeatedBlock2")
    parser.add_argument("--cost_type", type=str, default="pow_10")
    args = parser.parse_args()
    data_name = args.data_name
    for seed in [7,8,9]:
        print('seed:', seed)
        for mf_model in ["CMF_CAR_dkl","GP"]:
            ...
            for acq in ["UCB"]:
                ...
                try:
                    ...
                    path_csv = os.path.join('H:\\eda\\nips2024\\mfbo_v2', 'Experiment', 'CMF', 'Exp_results', data_name, exp_config['cost_type'])
