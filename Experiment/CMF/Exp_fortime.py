...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_name", type=str, default="Currin2")
    parser.add_argument("--cost_type", type=str, default="pow_10")
    args = parser.parse_args()
    data_name = args.data_name
    for seed in [0]:
        print('seed:', seed)
        for mf_model in ["GP","CMF_CAR","CMF_CAR_dkl"]:
            ...
            for acq in ["UCB"]:
                ...
                try:
                    ...
                    path_csv = os.path.join('D:\\luzhenjie\\mfbo_v2', 'Experiment', 'CMF', 'Exp_results_time', data_name, exp_config['cost_type'])
