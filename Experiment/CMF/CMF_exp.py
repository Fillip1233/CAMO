...
Data_list = {'non_linear_sin': non_linear_sin, 'forrester': forrester, 'Branin':Branin,'Park3':Park,"Currin3":Currin}
...
if __name__ == '__main__':
    ...
    for seed in [0,1,2,3,4]:
        print('seed:', seed)
        for mf_model in ["GP","CMF_CAR_dkl","CMF_CAR"]:
            ...
            for acq in ["UCB","cfKG"]:
                ...
                try:
                    ...
                    path_csv = os.path.join(sys.path[-1], 'Experiment', 'CMF', 'Exp_results', data_name, exp_config['cost_type'])
