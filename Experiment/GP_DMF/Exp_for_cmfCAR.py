...
MF_model_list = {'CMF_CAR':ContinuousAutoRegression_large,'CMF_CAR_dkl':CMF_CAR_dkl}
Acq_list = {'UCB': DMF_UCB, 'EI': DMF_EI, 'cfKG': GP_KG}
Data_list = {'non_linear_sin': non_linear_sin, 'forrester': forrester, 'tl2':tl2, 'tl3':tl3, 'test3':test3, 'test4':test4, 'maolin1':maolin1}
...
if __name__ == '__main__':
    ...
    for mf_model in ["CMF_CAR_dkl","CMF_CAR"]:
        # for acq in ["EI"]:
