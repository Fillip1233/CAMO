...
if __name__ == "__main__":
    ...
    for seed in range(30):
        ...
        directory = '/home/fillip/桌面/CAMO/Nips2025/CMF/smac_result/' + data_name + '/'
        if not os.path.exists(directory):
            os.makedirs(directory)
        df.to_csv('/home/fillip/桌面/CAMO/Nips2025/CMF/smac_result/' + data_name + '/smac_seed_' + str(seed) + '.csv', index=False)
