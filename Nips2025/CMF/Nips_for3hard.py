...
seed_dic = {'himmelblau':[0,3,4,6,7,8,9,11,13,14,15,16,17,18,19,20,22,23,24,25,28],
        ...
        'colvile':[0,3,4,5,8,9,11,12,13,14,15,17,19,20,21,22,24,25,28,29]}
...
plt.savefig(os.path.join(sys.path[-1], 'Nips2025', 'CMF','Graphs') + '/' + 'CMF_hard3_' + cost_name +'_SR_together.png', bbox_inches='tight')