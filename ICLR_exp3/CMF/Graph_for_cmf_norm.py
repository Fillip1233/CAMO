...
add_dict = {'forrester': 0.8 , 'non_linear_sin': 0,'Branin': 0.86,'Currin': 0.01,'Park': 0.1, 'himmelblau': 1,'bohachevsky': 4,'VibratePlate': 0, 'HeatedBlock': 1.2,}
## pow_10
cost_name = 'pow_10'
...
plt.savefig(os.path.join(sys.path[-1], 'ICLR_exp3', 'CMF', 'Graphs') + '/' +'CMF_'+ data_name +'_'+ cost_name +'_SR'+'.pdf', bbox_inches='tight')
